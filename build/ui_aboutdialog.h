...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About sucrecoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>sucrecoin</b> version", 0));
...
"Copyright \302\251 2018 sucrecoin Developers\n"
"        ", 0));
